...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://cdn.jsdelivr.net", "https://storage.googleapis.com", "https://facerec.ezwealth.in", "https://*.ezwealth.in"],
      imgSrc: ["'self'", "data:", "blob:", "https://storage.googleapis.com", "https://ezwealth.in", "https://*.ezwealth.in"],
